      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Deferred Processing', link: '/guide/deferred-processing' },
            ...
            { text: 'SMTP-IMAP Email Channel', link: '/guide/smtp-imap' },
            { text: 'SendGrid Email Channel', link: '/guide/sendgrid' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Monitoring & Alerting (operator guide)', link: '/guide/monitoring' },
          ],
        },
        {
          text: 'Security',
      ...
      '/api/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Deferred Processing', link: '/api/deferred-processing' },
          ],
        },
      ],
    },
