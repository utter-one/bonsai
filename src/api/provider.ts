...
export const createProviderSchema = z.object({
  ...
  type: providerTypeSchema.describe('Provider category: asr, tts, llm, or embeddings'),
  providerName: providerNameSchema.describe('Specific provider implementation (e.g., openai, anthropic, azure, elevenlabs)'),
  config: z.record(z.string(), z.unknown()).describe('Provider-specific configuration object (varies by type and providerName)'),
...
export const updateProviderBodySchema = z.object({
  ...
  type: providerTypeSchema.optional().describe('Updated provider category'),
  providerName: providerNameSchema.optional().describe('Updated specific provider implementation'),
...
export const providerResponseSchema = z.object({
  ...
  type: providerTypeSchema.describe('Provider category (asr, tts, llm, embeddings)'),
  providerName: providerNameSchema.describe('Specific provider implementation'),
