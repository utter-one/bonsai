  ...
  private getTtsProviders(): TtsProviderInfo[] {
    return [
      ...
      },
      {
        ...
        description: 'Google Gemini text-to-speech with controllable, natural language prompting for style, accent, and pace',
        models: [
          {
            id: 'gemini-2.5-flash-preview-tts',
            displayName: 'Gemini 2.5 Flash Preview TTS',
            description: 'Fast text-to-speech model with natural language controllability',
            recommended: true,
            languages: ['en', 'es', 'fr', 'de', 'it', 'pt', 'pl', 'nl', 'ja', 'zh', 'ko', 'ar', 'hi', 'ru', 'af', 'sq', 'am', 'hy', 'az', 'eu', 'be', 'bn', 'bg', 'my', 'ca', 'ceb', 'hr', 'cs', 'da', 'et', 'fil', 'fi', 'gl', 'ka', 'el', 'gu', 'ht', 'he', 'hu', 'is', 'id', 'ga', 'jv', 'kn', 'kk', 'kok', 'lo', 'la', 'lv', 'lt', 'lb', 'mk', 'mai', 'mg', 'ms', 'ml', 'mn', 'mr', 'ne', 'nb', 'nn', 'or', 'ps', 'fa', 'pa', 'ro', 'sr', 'sd', 'si', 'sk', 'sl', 'so', 'sw', 'sv', 'ta', 'te', 'th', 'tr', 'uk', 'ur', 'vi', 'cmn'],
            supportedAudioFormats: ['pcm_24000'],
          ...
          },
          {
            ...
            description: 'High-quality text-to-speech model with natural language controllability',
            languages: ['en', 'es', 'fr', 'de', 'it', 'pt', 'pl', 'nl', 'ja', 'zh', 'ko', 'ar', 'hi', 'ru', 'af', 'sq', 'am', 'hy', 'az', 'eu', 'be', 'bn', 'bg', 'my', 'ca', 'ceb', 'hr', 'cs', 'da', 'et', 'fil', 'fi', 'gl', 'ka', 'el', 'gu', 'ht', 'he', 'hu', 'is', 'id', 'ga', 'jv', 'kn', 'kk', 'kok', 'lo', 'la', 'lv', 'lt', 'lb', 'mk', 'mai', 'mg', 'ms', 'ml', 'mn', 'mr', 'ne', 'nb', 'nn', 'or', 'ps', 'fa', 'pa', 'ro', 'sr', 'sd', 'si', 'sk', 'sl', 'so', 'sw', 'sv', 'ta', 'te', 'th', 'tr', 'uk', 'ur', 'vi', 'cmn'],
            supportedAudioFormats: ['pcm_24000'],
            supportsFullStreaming: false,
            supportsVoiceSettings: true,
