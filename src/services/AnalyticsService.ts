  ...
  async getLatencyStats(projectId: string, query: AnalyticsQuery, context: RequestContext): Promise<LatencyStatsResponse> {
    ...
    const result = await db.execute(sql.raw(`
      SELECT
        ...
        ${this.buildMetricAggSQL('ttsConnectDurationMs')},
        ${this.buildMetricAggSQL('stageTransitionDurationMs')},
        ${this.buildMetricAggSQL('promptRenderDurationMs')},
    ...
    return {
      ...
      ttsConnectDurationMs: this.extractMetric(row, 'ttsConnectDurationMs'),
      stageTransitionDurationMs: this.extractMetric(row, 'stageTransitionDurationMs'),
      promptRenderDurationMs: this.extractMetric(row, 'promptRenderDurationMs'),
    ...
    for (const row of result.rows as any[]) {
      ...
      if (row.role === 'user') {
        turnMap.set(turnIndex, {
          ...
          stageTransitionStartMs: existing?.stageTransitionStartMs ?? null,
          stageTransitionEndMs: existing?.stageTransitionEndMs ?? null,
          promptRenderStartMs: existing?.promptRenderStartMs ?? null,
          promptRenderEndMs: existing?.promptRenderEndMs ?? null,
          ttsConnectStartMs: existing?.ttsConnectStartMs ?? null,
          ttsConnectEndMs: existing?.ttsConnectEndMs ?? null,
          stageTransitionDurationMs: existing?.stageTransitionDurationMs ?? null,
          ttsConnectDurationMs: existing?.ttsConnectDurationMs ?? null,
          promptRenderDurationMs: existing?.promptRenderDurationMs ?? null,
        ...
        turnMap.set(turnIndex, {
          ...
          stageTransitionStartMs: this.toNullableNumber(meta.stageTransitionStartMs),
          stageTransitionEndMs: this.toNullableNumber(meta.stageTransitionEndMs),
          stageTransitionDurationMs: this.toNullableNumber(meta.stageTransitionDurationMs),
          ttsConnectStartMs: this.toNullableNumber(meta.ttsConnectStartMs),
          ttsConnectEndMs: this.toNullableNumber(meta.ttsConnectEndMs),
          ttsConnectDurationMs: this.toNullableNumber(meta.ttsConnectDurationMs),
          promptRenderStartMs: this.toNullableNumber(meta.promptRenderStartMs),
          promptRenderEndMs: this.toNullableNumber(meta.promptRenderEndMs),
          promptRenderDurationMs: this.toNullableNumber(meta.promptRenderDurationMs),
