...
import type { ICommunicationChannel } from '../channels/ICommunicationChannel';
...
export class ConversationRunner {
  ...
  private channel: ICommunicationChannel;
  ...
  async prepareConversation(conversationId: string, session: Connection, channel: ICommunicationChannel): Promise<void> {
