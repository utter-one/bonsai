...
export const PERMISSIONS = {
  ...
  // Conversation Stage permissions
  CONVERSATION_STAGE_READ: 'conversation_stage:read',
  CONVERSATION_STAGE_WRITE: 'conversation_stage:write',
  CONVERSATION_STAGE_DELETE: 'conversation_stage:delete',
...
export const ROLES = {
  ...
  content_manager: {
    ...
    permissions: [
      ...
      PERMISSIONS.CONVERSATION_STAGE_READ,
      PERMISSIONS.CONVERSATION_STAGE_WRITE,
