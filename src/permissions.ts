...
export const ROLES = {
  ...
  content_manager: {
    ...
    permissions: [
      ...
      PERMISSIONS.GLOBAL_ACTION_DELETE,
      ...
      PERMISSIONS.SAMPLE_COPY_DELETE,
      PERMISSIONS.COPY_DECORATOR_READ,
      PERMISSIONS.COPY_DECORATOR_WRITE,
      PERMISSIONS.COPY_DECORATOR_DELETE,
