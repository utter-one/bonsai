...
export const createGlobalActionSchema = z.object({
  ...
  effects: z.preprocess(filterDeprecatedEffects, z.array(effectSchema)).optional().describe('Array of effects to execute when action is triggered'),
...
export const updateGlobalActionBodySchema = z.object({
  ...
  triggerOnExternal: z.boolean().optional().describe('Updated trigger on external flag'),
  ...
  effects: z.preprocess(filterDeprecatedEffects, z.array(effectSchema)).optional().describe('Updated effects array'),
...
export const globalActionResponseSchema = z.object({
  ...
  triggerOnExternal: z.boolean().describe('Whether this action can be triggered by external services via the external trigger endpoint'),
  ...
  effects: z.preprocess(filterDeprecatedEffects, z.array(effectSchema)).describe('Array of effects to execute'),
