...
import { createGlobalActionSchema, updateGlobalActionBodySchema, deleteGlobalActionBodySchema, globalActionResponseSchema, globalActionListResponseSchema } from '../contracts/globalAction';
...
export class GlobalActionController {
  ...
  @Get('/')
  async listGlobalActions(@Validated(listParamsSchema, 'query') @Req() req: Request) {
    return await this.globalActionService.listGlobalActions(req.query as unknown as ListParams);
  }
