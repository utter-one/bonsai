...
import { createAdminSchema, updateAdminBodySchema, deleteAdminBodySchema, adminResponseSchema, adminListResponseSchema } from '../contracts/admin';
import type { CreateAdminRequest, UpdateAdminRequest, DeleteAdminRequest } from '../contracts/admin';
...
export class AdminController {
  ...
  @RequirePermissions([PERMISSIONS.ADMIN_READ])
  @Get('/')
  async listAdmins(@Validated(listParamsSchema, 'query') @Req() req: Request) {
    return await this.adminService.listAdmins(req.query as unknown as ListParams);
  }
